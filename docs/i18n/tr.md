...
<div align="center">
  <a href="https://twitter.com/intent/tweet?via=serpdownme&url=https://github.com/serpdown/serpdown/&text=Uygulama%20için%20ne%20demek%20istersiniz?&hashtags=happyserpdown">
...
<h2 align="center">serpdown'e yardımda bulunma</h2>

serpdown, MIT lisanslı  ve açık kaynaklı bir projedir, ve en yeni versiyonu her zaman ücretsiz olarak GitHub'dan indirilebilir. serpdown hâlâ geliştirme aşamasında, ve bu geliştirme sponsorları sayesinde mümkün oluyor. Sponsor olmak isterseniz:

- [Become a backer or sponsor on Patreon](https://www.patreon.com/ranluo) or [One time donation](https://github.com/Jocs/sponsor.me)
- [Become a backer or sponsor on Open Collective](https://opencollective.com/serpdown)

##### Open Collective ve Patreon arasında ne fark var?

Patreon: Tüm yardım direkt olarak serpdown'i yapan ve sürdüren Luo Ran (@jocs)'a, gider.
Open Collective: Bu platformda tüm masraf ve harcamalarımız şeffaftır. Para, serpdown'in geliştirilmesi ve sürdürülmesi, çevrimiçi ve çevrimdışı aktiviteleri, ve gerekli kaynaklara erişimi için kullanılacaktır.
Tüm sponsorlarımızın (hem Patreon hem Open Collective) isimleri ve logoları serpdown'in resmi web sitesinde ve README.md dosyasında yer alır.
...
1. Yazmayı sevdiğimiz için. Birçok markdown editörü kullandık, ve hala benim gereksinimlerimi tam anlamı ile karşılayanı bir editör yok. Yazarken dayanılmaz bir bug ile uğraşmaktan hoşlanmıyorum. **serpdown** sayfayı çizmek için virtual DOM kullanır, bu da hızlı ve açık kaynaklı olması gibi avantajlar sağlıyor. Bu yolla yazmayı ve markdown'u seven bütün herkes serpdown kullanabilir.
2. Yukarıda bahsettiğim gibi **serpdown** daima açık kaynak olacak. Tüm markdown sevenlerin koda katkıda bulunmasını ve **serpdown**'in daha popüler bir markdown editör olmasını ümit ediyorum.
3. Birçok markdown editörü var, ve her biri kendi avantajlarına sahip. Tüm markdown kullanıcılarını tatmin etmek zor, ama biz **serpdown** 'in markdown kullanıcılarının gereksinimlerini mümkün oldukça tatmin edebileceğini umuyoruz. **serpdown** hala mükemmel değil, ancak biz elimizden geldiğince iyileştirmeye çalışıyoruz.
...
(`serpdown-setup-%version%.exe`) yükleyiciyi indirip çalıştırın.

Veya, serpdown'i [Chocolatey](https://chocolatey.org/) yoluyla kurun. Chocolatey kullanabilmek için [Chocolatey](https://chocolatey.org/install)'in kurulu olması gerekir.
...
Tüm Linux, macOS ve Windows sürümleri [indirmeler](https://github.com/serpdown/serpdown/releases/latest)'de bulunur. Kendi platformunuz için bir sürüm bulamıyorsanuz, [issue](https://github.com/serpdown/serpdown/issues) açınız.

## Geliştirme

Eğer **serpdown** kendiniz derlemek isterseniz, lütfen [geliştirici dökümantasyonuna](../../CONTRIBUTING.md#build-instructions) bakın.

- [Kullanıcı dokümantasyonu](../README.md)
- [Geliştirici dokümantasyonu](../dev/README.md)

**serpdown** hakkında sorularınız için issue açabilirsiniz. Lütfen standart formatı kullanın. Direkt olarak PR açmak tabiki hoş karşılanır.

## Entegrasyonlar

- [Alfred Workflow](http://www.packal.org/workflow/mark-text): macOS Alfred uygulaması için bir iş akışı: serpdown ile dosya/klasör açmak için "mt" kullanılır.

## Katkıda Bulunmak

serpdown geliştirme aşamasındadır. Lütfen pull request açmadan önce [Katkıda bulunma Rehberine](../../CONTRIBUTING.md) bakınız. serpdown'e katkıda bulunmak için [roadmap](https://github.com/serpdown/serpdown/projects)'e bakınız.

## Destekçiler

Tüm destekçilerimize teşekkürler! [[destekçiler](https://github.com/serpdown/serpdown/graphs/contributors)]

serpdown logosunu tasarlayan @[Yasujizr](https://github.com/Yasujizr)'a özel teşekkürler.
