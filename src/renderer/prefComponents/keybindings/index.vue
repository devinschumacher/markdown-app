<template>
  <div class="pref-keybindings">
    ...
    <section class="keybindings">
      <div class="text">
        Customize serpdown shortcuts and click on the save button below to apply all changes (requires a restart).
...
export default {
  ...
  mounted () {
    ...
    this.showDebugTools = global.serpdown.env.debug
  },
  ...
  methods: {
    openKeybindingWiki () {
      shell.openExternal('https://github.com/serpdown/serpdown/blob/master/docs/KEYBINDINGS.md')
    },
    saveKeybindings () {
