...
export default {
  ...
  methods: {
    ...
    reportViaGithub () {
      shell.openExternal('https://github.com/serpdown/serpdown/issues/new')
    },
    reportViaTwitter () {
      ...
      const params = {
        via: 'serpdownme',
        url: encodeURI('https://github.com/serpdown/serpdown/'),
        text: value
      }

      if (selectedFace === 'smile') params.hashtags = 'happyserpdown'
