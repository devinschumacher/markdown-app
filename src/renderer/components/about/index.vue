...
import bus from '../../bus'
import serpdownLogo from '../../assets/images/logo.png'

export default {
  data () {
    this.name = 'serpdown'
    this.copyright = `Copyright © 2017-${new Date().getFullYear()} Luo Ran`
    this.copyrightContributors = `Copyright © 2018-${new Date().getFullYear()} serpdown Contributors`
    this.logo = serpdownLogo
    return {
