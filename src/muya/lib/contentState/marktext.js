...
import { extractWord, offsetToWordCursor, validateLineCursor } from '../serpdown/spellchecker'
import selection from '../selection'

const serpdownApi = ContentState => {
  /**
   ...
   * is currently used to replace a misspelled word in serpdown that was selected
   * by Chromium.
   *
