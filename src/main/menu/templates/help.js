...
import { checkUpdates } from '../actions/serpdown'
...
export default function () {
  const helpMenu = {
    ...
    submenu: [{
      label: 'Quick Start...',
      click () {
        shell.openExternal('https://github.com/serpdown/serpdown/blob/master/docs/README.md')
      }
    }, {
      label: 'Markdown Reference...',
      click () {
        shell.openExternal('https://github.com/serpdown/serpdown/blob/master/docs/MARKDOWN_SYNTAX.md')
      }
    }, {
      label: 'Changelog...',
      click () {
        shell.openExternal('https://github.com/serpdown/serpdown/blob/master/.github/CHANGELOG.md')
      }
    }, {
      type: 'separator'
    }, {
      ...
      click (item, win) {
        shell.openExternal('https://opencollective.com/serpdown')
      }
    }, {
      ...
      click () {
        shell.openExternal('https://github.com/serpdown/serpdown/issues')
      }
    }, {
      type: 'separator'
    }, {
      label: 'Website...',
      click () {
        shell.openExternal('https://github.com/serpdown/serpdown')
      }
    }, {
      ...
      click () {
        shell.openExternal('https://twitter.com/serpdownapp')
      }
    }, {
      type: 'separator'
    }, {
      label: 'License...',
      click () {
        shell.openExternal('https://github.com/serpdown/serpdown/blob/master/LICENSE')
      }
    }]
  }
