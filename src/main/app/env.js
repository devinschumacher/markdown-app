...
const setupEnvironment = args => {
  ...
  const debug = args['--debug'] || !!process.env.serpdown_DEBUG || process.env.NODE_ENV !== 'production'
  ...
  global.serpdown_DEBUG = debug
  global.serpdown_DEBUG_VERBOSE = verbose
  global.serpdown_SAFE_MODE = safeMode
