...
const { getRendererEnvironmentDefinitions } = require('./serpdownEnvironment')
...
if (process.env.NODE_ENV !== 'production' && process.env.NODE_ENV !== 'test' &&
  !process.env.serpdown_DEV_HIDE_BROWSER_ANALYZER) {
  rendererConfig.plugins.push(
...
if (!isProduction && process.env.serpdown_BUILD_VSCODE_DEBUG) {
